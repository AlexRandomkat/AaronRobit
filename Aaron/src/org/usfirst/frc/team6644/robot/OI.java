...
import org.usfirst.frc.team6644.robot.commands.GrabberEStop;
...
public class OI {
	...
	public static JoystickButton grabberUp = new JoystickButton(Robot.joystick, 6);
	public static JoystickButton grabberDown = new JoystickButton(Robot.joystick, 7);
	public static JoystickButton grabberEStop = new JoystickButton(Robot.joystick, 8);
	...
	public static JoystickButton compensate = new JoystickButton(Robot.joystick, 12);
	...
	public OI() {
		...
		grabberEStop.whenPressed(new GrabberEStop());
	}
}
